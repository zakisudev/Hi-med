...
const Step3: React.FC<Step3Props> = ({
  ...
  const [complaintOption, setComplaintOption] = useState<string>('one');
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl">Select additional symptoms</h2>

        <div className="flex flex-col gap-5">
          <label>To proceed, select the option applicable to you</label>
          <div className="flex gap-4 items-center">
            <input
              ...
              id="one"
              value="one"
              checked={complaintOption === 'one'}
              onChange={() => setComplaintOption('one')}
              className="w-5 h-5 p-0 appearance-none border border-[#606060] rounded-full checked:bg-[#226699] checked:w-5 checked:h-5"
            />
            <label className="text-[22px] flex-1" htmlFor="one">
          ...
          <div className="flex gap-4 items-center">
            <input
              ...
              id="multiple"
              value="multiple"
              checked={complaintOption === 'multiple'}
              onChange={() => setComplaintOption('multiple')}
              className="w-5 h-5 p-0 appearance-none border border-[#606060] rounded-full checked:bg-[#226699] checked:w-5 checked:h-5"
            />
            <label className="text-[22px] flex-1" htmlFor="multiple">
      ...
      <section className="flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between gap-10 mt-5">
          ...
          >
            ...
            <span className="font-bold text-[18px]">Reset</span>
          </button>
          ...
          >
            <span className="font-bold text-[18px]">Submit form</span>
